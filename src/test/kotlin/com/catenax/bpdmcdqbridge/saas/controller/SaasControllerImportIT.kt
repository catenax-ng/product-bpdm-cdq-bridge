...
package com.catenax.bpdmcdqbridge.saas.controller

import com.catenax.bpdmcdqbridge.BpdmCdqBridgeApplication
import com.catenax.bpdmcdqbridge.saas.config.BpnConfigProperties
...
import com.catenax.bpdmcdqbridge.saas.util.*
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = [BpdmCdqBridgeApplication::class])
@ActiveProfiles("test")
@ContextConfiguration(initializers = [PostgreSQLContextInitializer::class,OpenSearchContextInitializer::class, BpdmPoolContextInitializer::class])
