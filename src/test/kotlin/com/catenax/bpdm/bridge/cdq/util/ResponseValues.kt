...
object ResponseValues {
    ...
    val nameType1 =
        TypeKeyNameUrlDto(CommonValues.nameType1, CommonValues.nameType1.getTypeName(), CommonValues.nameType1.getUrl())
    ...
    val statusType1 = TypeKeyNameUrlDto(
        CommonValues.statusType1,
        CommonValues.statusType1.getTypeName(),
        CommonValues.statusType1.getUrl()
    )
    val statusType2 = TypeKeyNameUrlDto(
        CommonValues.statusType2,
        CommonValues.statusType2.getTypeName(),
        CommonValues.statusType2.getUrl()
    )
    val statusType3 = TypeKeyNameUrlDto(
        CommonValues.statusType3,
        CommonValues.statusType3.getTypeName(),
        CommonValues.statusType3.getUrl()
    )

    val status1 = BusinessStatusResponse(
        CommonValues.statusDenotation1,
        CommonValues.statusValidFrom1, null, statusType1
    )
    val status2 = BusinessStatusResponse(
        CommonValues.statusDenotation2,
        CommonValues.statusValidFrom2, null, statusType2
    )
    val status3 = BusinessStatusResponse(
        CommonValues.statusDenotation3,
        CommonValues.statusValidFrom3, null, statusType3
    )
    ...
    val adminAreaType1 = TypeKeyNameUrlDto(
        CommonValues.adminAreaType1,
        CommonValues.adminAreaType1.getTypeName(),
        CommonValues.adminAreaType1.getUrl()
    )

    val adminArea1 =
        AdministrativeAreaResponse(value = CommonValues.adminArea1, type = adminAreaType1, language = language0)
    val adminArea2 =
        AdministrativeAreaResponse(value = CommonValues.adminArea2, type = adminAreaType1, language = language0)
    val adminArea3 =
        AdministrativeAreaResponse(value = CommonValues.adminArea3, type = adminAreaType1, language = language0)
    val adminArea4 =
        AdministrativeAreaResponse(value = CommonValues.adminArea4, type = adminAreaType1, language = language0)
    val adminArea5 =
        AdministrativeAreaResponse(value = CommonValues.adminArea5, type = adminAreaType1, language = language0)

    val postCodeType1 = TypeKeyNameUrlDto(
        CommonValues.postCodeType1,
        CommonValues.postCodeType1.getTypeName(),
        CommonValues.postCodeType1.getUrl()
    )
    ...
    val localityType1 = TypeKeyNameUrlDto(
        CommonValues.localityType1,
        CommonValues.localityType1.getTypeName(),
        CommonValues.localityType1.getUrl()
    )
    ...
    val thoroughfareType1 =
        TypeKeyNameUrlDto(
            CommonValues.thoroughfareType1,
            CommonValues.thoroughfareType1.getTypeName(),
            CommonValues.thoroughfareType1.getUrl()
        )

    val thoroughfare1 =
        ThoroughfareResponse(value = CommonValues.thoroughfare1, type = thoroughfareType1, language = language0)
    val thoroughfare2 =
        ThoroughfareResponse(value = CommonValues.thoroughfare2, type = thoroughfareType1, language = language0)
    val thoroughfare3 =
        ThoroughfareResponse(value = CommonValues.thoroughfare3, type = thoroughfareType1, language = language0)
    val thoroughfare4 =
        ThoroughfareResponse(value = CommonValues.thoroughfare4, type = thoroughfareType1, language = language0)
    val thoroughfare5 =
        ThoroughfareResponse(value = CommonValues.thoroughfare5, type = thoroughfareType1, language = language0)

    val premiseType1 = TypeKeyNameUrlDto(
        CommonValues.premiseType1,
        CommonValues.premiseType1.getTypeName(),
        CommonValues.premiseType1.getUrl()
    )
    ...
    val postalDeliveryPoint3 =
        PostalDeliveryPointResponse(
            value = CommonValues.postalDeliveryPoint3,
            type = postalDeliveryPointType1,
            language = language0
        )
    val postalDeliveryPoint4 =
        PostalDeliveryPointResponse(
            value = CommonValues.postalDeliveryPoint4,
            type = postalDeliveryPointType1,
            language = language0
        )
