...
import com.catenax.bpdm.bridge.cdq.util.OpenSearchContextInitializer.Companion.openSearchContainer
import com.catenax.bpdm.bridge.cdq.util.PostgreSQLContextInitializer.Companion.postgreSQLContainer
...
class BpdmPoolContextInitializer : ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    override fun initialize(applicationContext: ConfigurableApplicationContext) {
        ...
        TestPropertyValues.of(
            "bpdm.pool-client.url=http://localhost:${bpdmPoolContainer.getMappedPort(8080)}",
