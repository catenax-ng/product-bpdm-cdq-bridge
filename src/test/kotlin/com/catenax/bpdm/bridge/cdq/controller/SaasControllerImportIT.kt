...
import com.catenax.bpdm.bridge.cdq.BpdmCdqBridgeApplication
...
import com.catenax.bpdm.bridge.cdq.util.*
...
class SaasControllerImportIT @Autowired constructor(
    ...
    private val idTypeBpn = TypeKeyNameUrlSaas(saasAdapterConfigProperties.bpnKey, "Business Partner Number", "")
